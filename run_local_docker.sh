...
# Script to build and run the Nager URL Test 1772121510 MCP Server locally in Docker
...
IMAGE_NAME="nager-url-test-1772121510-mcp-server"
CONTAINER_NAME="nager-url-test-1772121510-mcp-local"
HOST_PORT=${PORT:-8000}
CONTAINER_PORT=${PORT:-8000}

echo -e "${BLUE}🚀 Building and running Nager URL Test 1772121510 MCP Server...${NC}"
echo
...
if [ ! -f .env ]; then
    ...
    if [ -f .env.example ]; then
        ...
        cat > .env << EOF
# Nager URL Test 1772121510 MCP Server Configuration
PORT=8000
STAGE=MAINNET
LOG_LEVEL=INFO
...
echo
echo -e "${GREEN}✅ Nager URL Test 1772121510 MCP Server is running!${NC}"
echo
